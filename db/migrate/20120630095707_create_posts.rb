class CreatePosts < ActiveRecord::Migration
  def up
    create_table :posts, :force => true do |t|
      t.column :post_title,       :string,    :null => false, :limit => 512
      t.column :slug,             :string,    :null => false, :limit => 200 # wp post_name
      t.column :post_excerpt,     :text,      :null => false
      t.column :post_content,     :longtext,  :null => false
      t.column :comment_count,    :integer,   :null => false, :limit => 20
